...
class JavaParserListener(ParseTreeListener):
    ...
    def enterPostIncrementDecrementOperatorExpression(self,
                                                      ctx: JavaParser.PostIncrementDecrementOperatorExpressionContext):
        pass

    # Exit a parse tree produced by JavaParser#PostIncrementDecrementOperatorExpression.
    def exitPostIncrementDecrementOperatorExpression(self,
                                                     ctx: JavaParser.PostIncrementDecrementOperatorExpressionContext):
        pass
