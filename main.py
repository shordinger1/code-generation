...
from Agent.minecraft.util import mod_generate
...
requirement = """
I need an item called invincible sword. It can kill any mobs in one attack.
"""
...
def main():
    mod_generate("AutoGeneratedMod", r"C:\Users\bcjPr\Desktop\gtnh\ExampleMod1.7.10", "shordinger", requirement)
    # mod.set_requirement(requirement)
    # mod.process()
    # mod.rag_init()
